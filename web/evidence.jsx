      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 18, display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 18 }}>
          <div>
            ...
            <div className="hud-panel" style={{ padding: 10 }}><NdviChart active={true} lang={lang} series={row.ndvi} /></div>
          </div>
          <div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
            ...
            {window.MIZAN_DATA.__real && row.lat ? <SnapBeforeAfter lang={lang} row={row} /> : <BeforeAfter lang={lang} />}
          </div>
        </div>
